...
func (h *DiscoveryHandler) Discover(ctx context.Context, req *pb.DiscoverServersRequest) (*pb.DiscoverServersResponse, error) {
	...
	return &pb.DiscoverServersResponse{Servers: resp}, nil
}
