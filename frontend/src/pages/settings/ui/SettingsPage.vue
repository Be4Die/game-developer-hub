      ...
      <div class="settings-content" v-if="activeTab === 'general'">
        ...
        <section class="settings-section">
          ...
          <div class="location-list">
            ...
            <label
              class="location-item"
              :class="{ active: location === 'petersburg' }"
            >
              <input
                type="radio"
                v-model="location"
            ...
            <label
              class="location-item"
              :class="{ active: location === 'novosibirsk' }"
            >
              <input
                type="radio"
                v-model="location"
      ...
      <div class="settings-content" v-if="activeTab === 'account'">
        ...
        <section class="settings-section">
          ...
          <p class="section-desc">
            Данные для входа в тестовую среду. Эти данные используются во всех
            проектах.
          </p>
          <div class="dev-env-box">
            <div class="dev-header">
              <MonitorPlay class="icon-sm text-primary" />
              <strong>Dev-среда</strong>
            </div>
            <p class="text-sm text-muted mb-16">
              Используйте эти данные для входа в игру:
            </p>
            <div class="credentials-row">
              <div class="cred-item">
                <span class="text-muted">Логин:</span>
                <code class="code-val">welwise</code>
              </div>
              <div class="cred-item">
                <span class="text-muted">Пароль:</span>
                <code class="code-val">1txqmYkZ-R</code>
              </div>
            </div>
          </div>
        </section>
