...
func (m *instMockNodeRepo) UpdatePlatformStatus(ctx context.Context, id int64, isPlatform bool) error {
	return nil
}

func (m *instMockNodeRepo) ListPlatformNodes(ctx context.Context) ([]*domain.Node, error) {
	return nil, nil
}
