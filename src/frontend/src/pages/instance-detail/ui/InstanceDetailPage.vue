    ...
    <div class="detail-header">
      <div class="header-left">
        <button
          ...
          @click="$router.push(`/projects/${gameId}/servers/instances`)"
        >
        ...
        <div class="card info-card">
          ...
          <div class="info-rows">
            ...
            <div class="info-row">
              ...
              ><span class="info-val"
                ><code>{{ instance.build_version }}</code></span
              >
            </div>
            <div class="info-row">
              <span class="info-label">Протокол</span
              ><span class="info-val">{{ instance.protocol }}</span>
            </div>
            <div class="info-row">
            ...
            <div class="info-row">
              ...
              ><span class="info-val">{{ instance.node_id }}</span>
            </div>
            <div class="info-row">
